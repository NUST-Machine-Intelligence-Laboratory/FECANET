...
def extract_feat_vgg(img, backbone):
...
def extract_feat_vgg_dense(img, backbone, feat_ids, bottleneck_ids=None, lids=None):
    feats = []
    feat = img
    for lid, module in enumerate(backbone.features):
        feat = module(feat)
...
def extract_feat_res(img, backbone):
    ...
    feat1 = backbone.layer1(feat)
    feat2 = backbone.layer2(feat1)
    feat3 = backbone.layer3(feat2)
    feat4 = backbone.layer4(feat3)
